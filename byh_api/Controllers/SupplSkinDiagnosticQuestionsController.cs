...
namespace byh_api.Controllers
{
    ...
    [ApiController]
    public class SupplSkinDiagnosticQuestionsController : ControllerBase
    {
        private readonly IConfiguration _configuration;

        public SupplSkinDiagnosticQuestionsController(IConfiguration configuration)
        {
        ...
        [HttpPost("PostSkinDiagnQuestions")]
        public JsonResult PostSkinDiagnQuestions(SupplSkinDiagnosticQuestions question)
        {
            Response response = new Response();
        ...
        [HttpPost("PostSkinSupplAdvice")]
        public JsonResult PostSkinSupplAdvice(SupplSkinDiagnosticQuestions question)
        {
            Response response = new Response();
