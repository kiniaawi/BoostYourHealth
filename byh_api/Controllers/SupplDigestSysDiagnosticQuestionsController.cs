...
namespace byh_api.Controllers
{
    ...
    [ApiController]
    public class SupplDigestSysDiagnosticQuestionsController : ControllerBase
    {
        private readonly IConfiguration _configuration;

        public SupplDigestSysDiagnosticQuestionsController(IConfiguration configuration)
        {
        ...
        [HttpPost("PostDigestSysDiagnQuestions")]
        public JsonResult PostDigestSysDiagnQuestions(SupplDigestSysDiagnosticQuestions question)
        {
            Response response = new Response();
        ...
        [HttpPost("PostDigestSysSupplAdvice")]
        public JsonResult PostDigestSysSupplAdvice(SupplDigestSysDiagnosticQuestions question)
        {
            Response response = new Response();
