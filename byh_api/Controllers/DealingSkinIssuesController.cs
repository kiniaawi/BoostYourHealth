...
namespace byh_api.Controllers
{
    ...
    [ApiController]
    public class DealingSkinIssuesController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public DealingSkinIssuesController(IConfiguration configuration)
        {
        ...
        public JsonResult Get()
        {
            ...
            try
            {
                string query = @"SELECT Id, SkinIssue, Solution, Description, IsDeleted from dbo.DealingSkinIssues";
        ...
        [HttpPost]
        public JsonResult Post(DealingSkinIssues dealIssue)
        {
            Response response = new Response();

            try
            {
                string query = @"INSERT INTO dbo.DealingSkinIssues VALUES(@SkinIssue, @Solution, @Description, 0)";
        ...
        public JsonResult Put(DealingSkinIssues dealIssue, int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.DealingSkinIssues SET SkinIssue = @SkinIssue, Solution = @Solution, 
        ...
        public JsonResult DelIssue(int Id)
        {
            ...
            try
            {
                string query = @"UPDATE dbo.DealingSkinIssues SET IsDeleted = 1
        ...
        public JsonResult RevIssue(int Id)
        {
            ...
            try
            {
                string query = @"UPDATE dbo.DealingSkinIssues SET IsDeleted = 0
