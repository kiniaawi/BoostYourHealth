...
namespace byh_api.Controllers
{
    ...
    [ApiController]
    public class SkinTypesTableController : ControllerBase
    {
        private readonly IConfiguration _configuration;

        public SkinTypesTableController(IConfiguration configuration)
        {
        ...
        public JsonResult Get()
        {
            ...
            try
            {
                string query = @"SELECT Id, SkinType, IsDeleted from dbo.SkinTypesTable";
        ...
        public JsonResult GetOnlyTypes()
        {
            ...
            try
            {
                string query = @"SELECT SkinType from dbo.SkinTypesTable";
        ...
        [HttpPost]
        public JsonResult Post(SkinTypesTable type)
        {
            Response response = new Response();

            try
            {
                string query = @"INSERT INTO dbo.SkinTypesTable VALUES(@SkinType, 0)";
                ...
                using (SqlConnection myConn = new SqlConnection(sqlDataSource))
                {
                    ...
                    using (SqlCommand myCommand = new SqlCommand(query, myConn))
                    {
                        myCommand.Parameters.AddWithValue("@SkinType", type.SkinType);
                        myReader = myCommand.ExecuteReader();
                        table.Load(myReader);
                        myReader.Close();
                        myConn.Close();
        ...
        [HttpPut("Update/{Id}")]
        public JsonResult Update(SkinTypesTable type, int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.SkinTypesTable SET SkinType = @SkinType WHERE Id = @Id";
        ...
        public JsonResult Delete(int Id)
        {
            ...
            try
            {
                string query = @"UPDATE dbo.SkinTypesTable SET IsDeleted = 1
        ...
        public JsonResult Revert(int Id)
        {
            ...
            try
            {
                string query = @"UPDATE dbo.SkinTypesTable SET IsDeleted = 0
