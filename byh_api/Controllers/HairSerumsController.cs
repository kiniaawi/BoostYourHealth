...
namespace byh_api.Controllers
{
    ...
    [ApiController]
    public class HairSerumsController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IWebHostEnvironment _env;

        public HairSerumsController(IConfiguration configuration, IWebHostEnvironment env)
        {
        ...
        public JsonResult Get()
        {
            ...
            try
            {
                string query = @"SELECT * from dbo.HairSerums";
        ...
        [HttpPost]
        public JsonResult Post(HairSerums prod)
        {
            Response response = new Response();

            try
            {
                string query = @"INSERT INTO dbo.HairSerums VALUES(@ProductName, @ProductTypeId, 
        ...
        [HttpPut("UpdateHairSerum/{Id}")]
        public JsonResult UpdateHairSerum(HairSerums prod, int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.HairSerums SET ProductName = @ProductName, ProductTypeId = @ProductTypeId, 
        ...
        [HttpPut("DelHairSerum/{Id}")]
        public JsonResult DelHairSerum(int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.HairSerums SET IsDeleted = 1
        ...
        [HttpPut("RevHairSerum/{Id}")]
        public JsonResult RevHairSerum(int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.HairSerums SET IsDeleted = 0
        ...
        public JsonResult SaveFile()
        {
            ...
            try
            {
                ...
                if (postedFile != null && postedFile.Length > 0)
                {
                    ...
                    var physicalPath = Path.Combine(_env.ContentRootPath, "Photos/HairSerums", filename);
