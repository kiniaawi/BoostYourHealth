...
namespace byh_api.Controllers
{
    ...
    [ApiController]
    public class HairConditionersController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        private readonly IWebHostEnvironment _env;

        public HairConditionersController(IConfiguration configuration, IWebHostEnvironment env)
        {
        ...
        public JsonResult Get()
        {
            ...
            try
            {
                string query = @"SELECT * from dbo.HairConditioners";
        ...
        [HttpPost]
        public JsonResult Post(HairConditioners prod)
        {
            Response response = new Response();

            try
            {
                string query = @"INSERT INTO dbo.HairConditioners VALUES(@ProductName, @ProductTypeId, 
        ...
        [HttpPut("UpdateHairConditioner/{Id}")]
        public JsonResult UpdateHairConditioner(HairConditioners prod, int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.HairConditioners SET ProductName = @ProductName, ProductTypeId = @ProductTypeId, 
        ...
        [HttpPut("DelHairConditioner/{Id}")]
        public JsonResult DelHairConditioner(int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.HairConditioners SET IsDeleted = 1
                ...
                using (SqlConnection myConn = new SqlConnection(sqlDataSource))
                {
                    ...
                    response.StatusCode = 200;
                    response.StatusMessage = "HairConditioners Deleted Successfully";
                    HttpContext.Response.StatusCode = response.StatusCode;
                    response.Data = table;
                }
            }
            catch (Exception ex)
            {
                ...
                response.StatusCode = 100;
                response.StatusMessage = "Failed to Delete HairConditioners";
                HttpContext.Response.StatusCode = response.StatusCode;
            }
        ...
        [HttpPut("RevHairConditioner/{Id}")]
        public JsonResult RevHairConditioner(int Id)
        {
            Response response = new Response();

            try
            {
                string query = @"UPDATE dbo.HairConditioners SET IsDeleted = 0
                ...
                using (SqlConnection myConn = new SqlConnection(sqlDataSource))
                {
                    ...
                    response.StatusCode = 200;
                    response.StatusMessage = "HairConditioners Reverted Successfully";
                    HttpContext.Response.StatusCode = response.StatusCode;
                    response.Data = table;
                }
            }
            catch (Exception ex)
            {
                ...
                response.StatusCode = 100;
                response.StatusMessage = "Failed to Revert HairConditioners";
                HttpContext.Response.StatusCode = response.StatusCode;
            }
        ...
        public JsonResult SaveFile()
        {
            ...
            try
            {
                ...
                if (postedFile != null && postedFile.Length > 0)
                {
                    ...
                    var physicalPath = Path.Combine(_env.ContentRootPath, "Photos/HairConditioners", filename);
