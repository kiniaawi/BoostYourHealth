...
const HairPeelingsTable = () => {
  ...
  const handleAddFile = () => {
    ...
    axios
      .post("/api/HairPeelings/SaveFile", formData)
      .then((response) => {
        alert(response);
      })
      .catch((error) => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(`/api/HairPeelings/UpdateHairPeeling/${editProduct.Id}`, data)
      .then((response) => {
        fetchProducts();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/HairPeelings/RevHairPeeling/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/HairPeelings/DelHairPeeling/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
...
export default HairPeelingsTable;
