...
const HairConditionersTable = () => {
  ...
  const handleAddFile = () => {
    ...
    axios
      .post("/api/HairConditioners/SaveFile", formData)
      .then((response) => {
        alert(response);
      })
      .catch((error) => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(
        `/api/HairConditioners/UpdateHairConditioner/${editProduct.Id}`,
        data
      )
      .then((response) => {
        fetchProducts();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/HairConditioners/RevHairConditioner/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/HairConditioners/DelHairConditioner/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>
              Nie Znaleziono Odżywek do Włosów w Bazie Danych
            </Typography>
          </Box>
        )}
      </div>
...
export default HairConditionersTable;
