...
import HairConditionersTable from "./HairConditionersTable";

const HairConditioners = ({ onChangeContent }) => {
  const [cookies, setCookie, removeCookie] = useCookies([
    "emailCookie",
    "currentPageCookie",
  ]);
  setCookie("currentPageCookie", "hair-conditioners", { path: "/" });
  ...
  const handleAddProduct = () => {
    ...
    axios
      .post("api/HairConditioners", data)
      .then((response) => {
  ...
  return (
    <Box p={2} sx={{ height: "300vh" }}>
      ...
      <Box>
        <HairConditionersTable />
      </Box>
    </Box>
  );
};

export default HairConditioners;
