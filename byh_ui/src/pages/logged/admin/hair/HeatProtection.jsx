...
import HeatProtectionTable from "./HeatProtectionTable";

const HeatProtection = ({ onChangeContent }) => {
  const [cookies, setCookie, removeCookie] = useCookies([
    "emailCookie",
    "currentPageCookie",
  ]);
  setCookie("currentPageCookie", "heat-protection", { path: "/" });
  ...
  return (
    <Box p={2} sx={{ height: "300vh" }}>
      ...
      <Typography variant="h5" sx={{ textAlign: "center", marginBottom: 3 }}>
        <b>Panel Produktów Termoochronnych</b>
      </Typography>
      <Card>
        <CardHeader
          title={
