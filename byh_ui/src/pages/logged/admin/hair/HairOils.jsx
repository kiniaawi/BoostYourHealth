...
import HairOilsTable from "./HairOilsTable";

const HairOils = ({ onChangeContent }) => {
  const [cookies, setCookie, removeCookie] = useCookies([
    "emailCookie",
    "currentPageCookie",
  ]);
  setCookie("currentPageCookie", "hair-oils", { path: "/" });
