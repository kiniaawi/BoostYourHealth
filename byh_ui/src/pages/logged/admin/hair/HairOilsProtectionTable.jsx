...
const HairOilsProtectionTable = () => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(
        `/api/HairOilProtection/UpdateHairOilsProtection/${editProduct.Id}`,
        data
      )
      .then((response) => {
        fetchProducts();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/HairOilProtection/RevHairOilsProtection/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/HairOilProtection/DelHairOilsProtection/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
          ...
          <Grid container spacing={2}>
            <Card>
              <Typography variant="h5" sx={{ textAlign: "center", p: 3 }}>
                <b>Edytuj Olejek Ochornny do Włosów </b>
              </Typography>
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
            ...
            <CardContent>
              <Box>
                <Typography variant="h6" textAlign={"center"} marginBottom={1}>
                  <b>Tabela Olejków Ochronnych do Włosów</b>
                </Typography>
              </Box>
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>
              Nie Znaleziono Olejków Ochronnych do Włosów w Bazie Danych
            </Typography>
          </Box>
        )}
      </div>
...
export default HairOilsProtectionTable;
