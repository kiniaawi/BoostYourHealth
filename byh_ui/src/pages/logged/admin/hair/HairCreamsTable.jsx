...
const HairCreamsTable = () => {
  ...
  const handleEdit = () => {
    ...
    axios
      .put(`/api/HairCreams/Update${editProduct.Id}`, data)
      .then((response) => {
        fetchProducts();
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/HairCreams/Revert/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/HairCreams/Delete/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchProducts();
      })
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>
              Nie Znaleziono Kremów do Włosów w Bazie Danych
            </Typography>
          </Box>
        )}
      </div>
...
export default HairCreamsTable;
