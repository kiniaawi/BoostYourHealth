...
import HairMasksTable from "./HairMasksTable";

const HairMasks = ({ onChangeContent }) => {
  const [cookies, setCookie, removeCookie] = useCookies([
    "emailCookie",
    "currentPageCookie",
  ]);
  setCookie("currentPageCookie", "hair-masks", { path: "/" });
