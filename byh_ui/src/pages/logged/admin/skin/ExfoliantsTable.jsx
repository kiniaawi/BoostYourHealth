...
const ExfoliantsTable = () => {
  ...
  const handleRevert = () => {
    ...
    axios
      .put(`/api/Exfoliants/RevExfoliant/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchExfoliants();
      })
  ...
  const handleDelete = () => {
    console.log(selectedProduct);
    axios
      .put(`/api/Exfoliants/DelExfoliant/${selectedProduct.Id}`)
      .then((response) => {
        console.log(selectedProduct);
        fetchExfoliants();
      })
          ...
          <Grid container spacing={2}>
            <Card>
              <Typography variant="h5" sx={{ textAlign: "center", p: 3 }}>
                <b>Edytuj Produkt Złuszczania</b>
              </Typography>
      ...
      <div style={{ overflow: "auto" }}>
        {productsData && productsData.length !== 0 ? (
          ...
          <Box textAlign={"center"} marginTop={2}>
            <Typography>
              Nie Znaleziono Produktów do Złuszczania w Bazie Danych
            </Typography>
          </Box>
        )}
      </div>
