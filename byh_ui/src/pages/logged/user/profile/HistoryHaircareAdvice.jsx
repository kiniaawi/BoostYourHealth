...
const HistoryHaircareAdvice = ({ onChangeContent }) => {
  ...
  setCookie("currentPageCookie", "history-haircare-advices", {
    path: "/",
  });
  ...
  const handleDelete = () => {
    ...
    axios
      .put(`/api/HaircareAdvice/Delete/${selectedAdvice.Id}`)
      .then((response) => {
        console.log(selectedAdvice);
        fetchAllAdvices();
      })
          ...
          {allAdvices && allAdvices.length !== 0 ? (
            <Card sx={{ marginBottom: 5 }}>
              <CardContent>
                ...
                <div>
                  <DataGrid
                    columns={HaircareAdvicesColumns}
...
export default HistoryHaircareAdvice;
